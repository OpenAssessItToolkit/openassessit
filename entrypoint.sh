...
cd openassessit;
lighthouse $1 --only-categories=accessibility --no-enable-error-reporting --disable-device-emulation --chrome-flags="--headless --window-size=1300,600 --no-sandbox --disable-gpu" --output="json" --output-path="/tmp/$2/$2.json";
